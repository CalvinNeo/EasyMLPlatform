...
class Tree:
	...
	def plotTree(self, myTree, parentPt, nodeTxt):
		...
		cntrPt = (self.xOff, self.yOff + (1.0 + leaves) / 2.0 / self.leafcount)
	...
	def createPlot(self):
		...
		self.xOff, self.yOff = 0, -0.5 / self.leafcount
		self.plotTree(self.jsonobj, (0, 0.5), '')
		plt.show()
